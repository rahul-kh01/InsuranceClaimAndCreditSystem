...
public interface CreditScoreRepository extends JpaRepository<CreditScore, Integer> {
     ...
     */
    List<CreditScore> findByUserId(Long userId);
     ...
     */
    CreditScore findTopByUserIdOrderByDateDesc(Long userId);

    // Removed invalid query method based on non-existent field 'emailId' in CreditScore entity.
