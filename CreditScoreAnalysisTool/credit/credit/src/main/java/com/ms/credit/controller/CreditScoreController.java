...
public class CreditScoreController {
    ...
    @GetMapping("/{userId}")
    public CreditScoreDTO getCreditScore(@PathVariable Long userId, HttpServletRequest request) {
        String jwtToken = extractJwtToken(request);
        if (jwtToken != null) {
            return creditScoreService.getCreditScoreByEmailId(userId, jwtToken);
        }
    ...
    public CreditScoreDTO calculateCreditScore(@RequestBody CreditScoreDTO creditScoreDTO, HttpServletRequest request) {
        String jwtToken = extractJwtToken(request);
        if (jwtToken != null) {
            return creditScoreService.calculateCreditScore(creditScoreDTO, jwtToken);
        }
    ...
    @PutMapping("/{userId}")
    public CreditScoreDTO updateCreditScore(@PathVariable Long userId, @RequestBody CreditScoreDTO creditScoreDTO) {
    ...
    public void deleteCreditScore(@PathVariable Long userId) {
    ...
    public List<ScoreHistoryDTO> getCreditScoreHistory(@PathVariable Long userId) {
