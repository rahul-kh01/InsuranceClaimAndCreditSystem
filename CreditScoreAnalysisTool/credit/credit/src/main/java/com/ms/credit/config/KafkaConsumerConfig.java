...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, FinancialDataDTO> consumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "credit-group");  // Group ID for this consumer group.
     ...
     */
    @KafkaListener(topics = "credit-score-updates", groupId = "credit-group")
    public void handleCreditScoreUpdate(FinancialDataDTO message) {
