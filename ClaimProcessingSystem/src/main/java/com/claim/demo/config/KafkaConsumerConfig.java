...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, ClaimStatusUpdateMessage> consumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "claim-group");  // Consumer group ID
    ...
    /**
     * Kafka listener to handle messages from 'claim-status-updates' topic.
     ...
     */
    @KafkaListener(topics = "claim-status-updates", groupId = "claim-group")
