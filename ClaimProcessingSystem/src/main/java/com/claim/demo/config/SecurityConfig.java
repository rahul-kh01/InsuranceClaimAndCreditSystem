...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            .csrf(csrf -> csrf.disable())  // Disable CSRF (Cross Site Request Forgery) protection since tokens are immune to this attack.
            ...
            .oauth2Login(oauth2 -> oauth2
                .loginPage("/login"))  // Enable OAuth2 login functionality.
